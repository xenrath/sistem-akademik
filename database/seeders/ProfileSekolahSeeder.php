...
class ProfileSekolahSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $profilesekolah = [
            ...
            'galeri_gambar' => [
                'menu-galeri/galeri-gambar-1.jpg',
                'menu-galeri/galeri-gambar-2.jpg',
                'menu-galeri/galeri-gambar-3.jpg',
            ],
            'ppdb_flayer' => 'menu-ppdb/ppdb-flayer.png',
            ...
            'link_facebook' => 'https://facebook.com/sdnabc',
            'link_instagram' => 'https://instagram.com/sdnabc',
        ];
