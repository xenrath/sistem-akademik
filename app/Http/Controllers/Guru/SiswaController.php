...
class SiswaController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('guru.siswa.create', compact('gurus', 'kelass'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('guru.siswa')->with('success', 'Berhasil menambahkan siswa');
    }
    ...
    public function edit($id)
    {
        ...
        $guru = User::where(['level' => 'guru'])->get();
        $kelass = Kelas::all();
        return view('guru.siswa.update', compact('siswa', 'guru', 'kelass'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('guru.siswa')->with('success', 'Berhasil memperbarui siswa');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('guru.siswa')->with('success', 'Berhasil menghapus siswa');
    }
}